...
function getOutliningSpanForNode(
	...
	switch (n.kind) {
		...
		case SyntaxKind.DefaultClause:
			return spanForNodeArray(
				(n as CaseClause | DefaultClause).statements,
			);
		...
		case SyntaxKind.JsxOpeningElement:
			return spanForJSXAttributes(
				(n as JsxOpeningLikeElement).attributes,
			);
		...
		case SyntaxKind.ImportAttributes:
			return spanForImportExportElements(
				n as NamedImports | NamedExports | ImportAttributes,
			);
	}

	function spanForImportExportElements(
		node: NamedImports | NamedExports | ImportAttributes,
	) {
...
function spanBetweenTokens(
	...
	const textSpan = createTextSpanFromBounds(
		useFullStart
			? openToken.getFullStart()
			: openToken.getStart(sourceFile),
		closeToken.getEnd(),
	);
	return createOutliningSpan(
		textSpan,
