		...
		Object.defineProperty(Identifier.prototype, "originalKeywordKind", {
			get: deprecate(
				...
				},
				{
					...
					errorAfter: "5.2",
					message:
						"Use 'identifierToKeywordKind(identifier)' instead.",
				},
			),
		});
	}
		...
		Object.defineProperty(Identifier.prototype, "isInJSDocNamespace", {
			get: deprecate(
				function (this: Identifier) {
					...
					return this.flags & NodeFlags.IdentifierIsInJSDocNamespace
						? true
						: undefined;
				},
				{
					...
					errorAfter: "5.2",
					message:
						"Use '.parent' or the surrounding context to determine this instead.",
				},
			),
		});
	}
