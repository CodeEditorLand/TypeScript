...
export const enum ModifierFlags {
	...
	/** @internal */ SyntacticOrJSDocModifiers = Public |
		Private |
		Protected |
		Readonly |
		Override,
	/** @internal */ SyntacticOnlyModifiers = Export |
		Ambient |
		Abstract |
		Static |
		Accessor |
		...
		Out |
		Decorator,
	/** @internal */ SyntacticModifiers = SyntacticOrJSDocModifiers |
		SyntacticOnlyModifiers,
	/** @internal */ JSDocCacheOnlyModifiers = JSDocPublic |
		JSDocPrivate |
		JSDocProtected |
		JSDocReadonly |
		JSDocOverride,
	/** @internal */ JSDocOnlyModifiers = Deprecated,
	/** @internal */ NonCacheOnlyModifiers = SyntacticOrJSDocModifiers |
		SyntacticOnlyModifiers |
		JSDocOnlyModifiers,
...
/** @internal */
export interface PrivateIdentifierAutoAccessorPropertyDeclaration
	extends AutoAccessorPropertyDeclaration {
	name: PrivateIdentifier;
}
/** @internal */
...
export interface GetAccessorDeclaration
	...
	// The following properties are used only to report grammar errors (see `isGrammarError` in utilities.ts)
	/** @internal */ readonly typeParameters?:
		| NodeArray<TypeParameterDeclaration>
		| undefined; // A get accessor cannot have type parameters
}
...
export interface SetAccessorDeclaration
	...
	/** @internal */ readonly typeParameters?:
		| NodeArray<TypeParameterDeclaration>
		| undefined; // A set accessor cannot have type parameters
...
/** @internal */
export type ObjectAssignmentElement = Exclude<
	ObjectBindingOrAssignmentElement,
	BindingElement
>;
...
/** @internal */
export type ArrayAssignmentElement = Exclude<
	ArrayBindingOrAssignmentElement,
	BindingElement
>;
...
/** @internal */
export type AssignmentElementTarget = Exclude<
...
export const enum TokenFlags {
	...
	/** @internal */
	TemplateLiteralLikeFlags = HexEscape |
		UnicodeEscape |
		ExtendedUnicodeEscape |
		ContainsInvalidEscape,
	/** @internal */
...
export type BindingElementOfBareOrAccessedRequire = BindingElement & {
	parent: {
		parent: VariableDeclarationInitializedTo<
...
export interface EmitHost
	...
	/** @deprecated */ getPrependNodes(): readonly (
		| InputFiles
		| UnparsedSource
	)[];
...
export interface ParenthesizerRules {
	...
	parenthesizeConstituentTypesOfUnionType(
		constituents: readonly TypeNode[],
	): NodeArray<TypeNode>;
...
export interface NodeFactory {
	...
	/** @deprecated @internal */ createUnparsedPrologue(
		data?: string,
	): UnparsedPrologue;
	...
	/** @deprecated @internal */ createUnparsedTextLike(
		data: string | undefined,
		internal: boolean,
	): UnparsedTextLike;
...
export const enum ListFormat {
	...
	ObjectLiteralExpressionProperties = PreserveLines |
		...
		Braces |
		NoSpaceIfEmpty,
	ImportAttributes = PreserveLines |
		CommaDelimited |
		SpaceBetweenSiblings |
		SpaceBetweenBraces |
		Indented |
	...
	ConcretePragmaSpecs[KPrag] extends {
		...
		? UnionToIntersection<
				ArgumentDefinitionToFieldUnion<
					ConcretePragmaSpecs[KPrag]["args"]
				>
			>
		: never;
