...
function checkDeclarationFiles(file: File, session: TestSession): void {
	...
	session.logger.log(
		`ts.getFileEmitOutput: ${file.path}: ${jsonToReadableText(output)}`,
	);
...
describe("unittests:: tsserver:: with declaration file maps:: project references", () => {
	...
	it("getDefinitionAndBoundSpan with file navigation", () => {
		...
		baselineTsserverLogs(
			"declarationFileMaps",
			"getDefinitionAndBoundSpan with file navigation",
			session,
		);
	});
	...
	it("goToDefinition -- target does not exist", () => {
		...
		baselineTsserverLogs(
			"declarationFileMaps",
			"goToDefinition target does not exist",
			session,
		);
	});
	...
	it("navigateToAll -- when neither file nor project is specified", () => {
		...
		baselineTsserverLogs(
			"declarationFileMaps",
			"navigateToAll neither file not project is specified",
			session,
		);
	});
	...
	it("navigateToAll -- when file is not specified but project is", () => {
		...
		baselineTsserverLogs(
			"declarationFileMaps",
			"navigateToAll file is not specified but project is",
			session,
		);
	});
	...
	it("findAllReferences -- starting at definition", () => {
		...
		baselineTsserverLogs(
			"declarationFileMaps",
			"findAllReferences starting at definition",
			session,
		);
	});

	interface ReferencesFullRequest
	...
	it("findAllReferencesFull definition is in mapped file", () => {
		...
		baselineTsserverLogs(
			"declarationFileMaps",
			"findAllReferencesFull definition is in mapped file",
			session,
		);
	});
	...
	it("findAllReferences -- target does not exist", () => {
		...
		baselineTsserverLogs(
			"declarationFileMaps",
			"findAllReferences target does not exist",
			session,
		);
	});
	...
	it("renameLocations -- starting at definition", () => {
		...
		baselineTsserverLogs(
			"declarationFileMaps",
			"renameLocations starting at definition",
			session,
		);
	});
	...
	it("renameLocations -- target does not exist", () => {
		...
		baselineTsserverLogs(
			"declarationFileMaps",
			"renameLocations target does not exist",
			session,
		);
	});
	...
	it("does not jump to source if inlined sources", () => {
		...
		baselineTsserverLogs(
			"declarationFileMaps",
			"does not jump to source if inlined sources",
			session,
		);
	});
});
