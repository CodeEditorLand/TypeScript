...
`,
			...
			describe("with external projects and config files ", () => {
				...
				function createSessionAndOpenProject(
				...
				it("when lazyConfiguredProjectsFromExternalProject is false", () => {
					const session = createSessionAndOpenProject(
	...
	verifyProjectLoadingStartAndFinish(
		"when using event handler",
		createSessionWithCustomEventHandler,
	);
	verifyProjectLoadingStartAndFinish(
		"when using default event handler",
