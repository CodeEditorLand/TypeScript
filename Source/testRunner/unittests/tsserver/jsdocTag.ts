...
;`,
	...
	assertQuickInfoJSDoc(
		"for quickinfo, should provide a string for a working link in a tag",
		linkInTag,
		{
			command: ts.server.protocol.CommandTypes.Quickinfo,
	...
	assertQuickInfoJSDoc(
		"for quickinfo, should provide display parts for a working link in a comment",
		linkInComment,
		{
			command: ts.server.protocol.CommandTypes.Quickinfo,
			displayPartsForJSDoc: true,
	...
	assertQuickInfoJSDoc(
		"for quickinfo, should provide a string for a working link in a comment",
		linkInComment,
		{
			command: ts.server.protocol.CommandTypes.Quickinfo,
			displayPartsForJSDoc: false,
	...
	assertQuickInfoJSDoc(
		"for quickinfo-full, should provide a string for a working link in a tag",
		linkInTag,
		{
			command: ts.server.protocol.CommandTypes.QuickinfoFull,
			displayPartsForJSDoc: false,
	...
	assertQuickInfoJSDoc(
		"for quickinfo-full, should provide a string for a working link in a comment",
		linkInComment,
		{
			command: ts.server.protocol.CommandTypes.QuickinfoFull,
			displayPartsForJSDoc: false,
	...
	function assertSignatureHelpJSDoc(
		subScenario: string,
		options: {
			displayPartsForJSDoc: boolean;
			command: ts.server.protocol.CommandTypes;
...
x(1)`,
			...
			session.executeCommandSeq<ts.server.protocol.SignatureHelpRequest>({
				command:
					command as ts.server.protocol.CommandTypes.SignatureHelp,
				arguments: {
					triggerReason: {
						kind: "invoked",
					},
	...
	assertSignatureHelpJSDoc(
		"for signature help, should provide a string for a working link in a comment",
		{
	...
	assertSignatureHelpJSDoc(
		"for signature help, should provide display parts for a working link in a comment",
		{
			command: ts.server.protocol.CommandTypes.SignatureHelp,
			displayPartsForJSDoc: true,
		},
	...
	assertSignatureHelpJSDoc(
		"for signature help-full, should provide a string for a working link in a comment",
		{
	...
	assertSignatureHelpJSDoc(
		"for signature help-full, should provide display parts for a working link in a comment",
		{
			command: ts.server.protocol.CommandTypes.SignatureHelpFull,
			displayPartsForJSDoc: true,
		},
	...
	function assertCompletionsJSDoc(
		subScenario: string,
		options: {
			displayPartsForJSDoc: boolean;
			command: ts.server.protocol.CommandTypes;
...
foo`,
			...
			session.executeCommandSeq<ts.server.protocol.CompletionDetailsRequest>(
				{
					command:
						command as ts.server.protocol.CommandTypes.CompletionDetails,
					arguments: {
						entryNames: ["foo"],
	...
	assertCompletionsJSDoc(
		"for completions, should provide display parts for a working link in a comment",
		{
	...
	assertCompletionsJSDoc(
		"for completions, should provide a string for a working link in a comment",
		{
			command: ts.server.protocol.CommandTypes.CompletionDetails,
			displayPartsForJSDoc: false,
		},
	...
	assertCompletionsJSDoc(
		"for completions-full, should provide display parts for a working link in a comment",
		{
	...
	assertCompletionsJSDoc(
		"for completions-full, should provide a string for a working link in a comment",
		{
			command: ts.server.protocol.CommandTypes.CompletionDetailsFull,
			displayPartsForJSDoc: false,
		},
