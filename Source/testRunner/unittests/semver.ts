...
describe("unittests:: semver", () => {
	describe("Version", () => {
		...
		describe("new", () => {
			it("text", () => {
				assertVersion(new ts.Version("1.2.3-pre.4+build.5"), [
					1,
					2,
					3,
					["pre", "4"],
			...
			it("parts", () => {
				...
				assertVersion(
					new ts.Version(1, 2, 3, ["pre", "4"], ["build", "5"]),
					[1, 2, 3, ["pre", "4"], ["build", "5"]],
				);
		...
		it("toString", () => {
			assert.strictEqual(
				new ts.Version(1, 2, 3, "pre.4", "build.5").toString(),
				"1.2.3-pre.4+build.5",
			);
			assert.strictEqual(
				new ts.Version(1, 2, 3, "pre.4").toString(),
				"1.2.3-pre.4",
			);
			assert.strictEqual(
				new ts.Version(
		...
		it("compareTo", () => {
			...
			assert.strictEqual(
				new ts.Version("1.0.0").compareTo(new ts.Version("2.0.0")),
				ts.Comparison.LessThan,
			);
			assert.strictEqual(
				new ts.Version("1.0.0").compareTo(new ts.Version("1.1.0")),
				ts.Comparison.LessThan,
			);
			assert.strictEqual(
				new ts.Version("1.0.0").compareTo(new ts.Version("1.0.1")),
				ts.Comparison.LessThan,
			);
			assert.strictEqual(
				new ts.Version("2.0.0").compareTo(new ts.Version("1.0.0")),
				ts.Comparison.GreaterThan,
			);
			assert.strictEqual(
				new ts.Version("1.1.0").compareTo(new ts.Version("1.0.0")),
				ts.Comparison.GreaterThan,
			);
			assert.strictEqual(
				new ts.Version("1.0.1").compareTo(new ts.Version("1.0.0")),
				ts.Comparison.GreaterThan,
			);
			assert.strictEqual(
				new ts.Version("1.0.0").compareTo(new ts.Version("1.0.0")),
			...
			assert.strictEqual(
				new ts.Version("1.0.0-pre").compareTo(new ts.Version("1.0.0")),
				ts.Comparison.LessThan,
			);
			...
			assert.strictEqual(
				new ts.Version("1.0.0-0").compareTo(new ts.Version("1.0.0-1")),
				ts.Comparison.LessThan,
			);
			assert.strictEqual(
			...
			assert.strictEqual(
				new ts.Version("1.0.0-2").compareTo(new ts.Version("1.0.0-10")),
				ts.Comparison.LessThan,
			);
			assert.strictEqual(
			...
			assert.strictEqual(
				new ts.Version("1.0.0-0").compareTo(new ts.Version("1.0.0-0")),
				ts.Comparison.EqualTo,
			);
			...
			assert.strictEqual(
				new ts.Version("1.0.0-a").compareTo(new ts.Version("1.0.0-b")),
				ts.Comparison.LessThan,
			);
			assert.strictEqual(
				new ts.Version("1.0.0-a-2").compareTo(
					new ts.Version("1.0.0-a-10"),
				),
				ts.Comparison.GreaterThan,
			);
			assert.strictEqual(
			...
			assert.strictEqual(
				new ts.Version("1.0.0-a").compareTo(new ts.Version("1.0.0-a")),
				ts.Comparison.EqualTo,
			);
			assert.strictEqual(
				new ts.Version("1.0.0-A").compareTo(new ts.Version("1.0.0-a")),
			...
			assert.strictEqual(
				new ts.Version("1.0.0-0").compareTo(
					new ts.Version("1.0.0-alpha"),
				),
				ts.Comparison.LessThan,
			);
			assert.strictEqual(
				new ts.Version("1.0.0-alpha").compareTo(
					new ts.Version("1.0.0-0"),
				),
				ts.Comparison.GreaterThan,
			);
			assert.strictEqual(
			...
			assert.strictEqual(
				new ts.Version("1.0.0-alpha").compareTo(
					new ts.Version("1.0.0-alpha.0"),
				),
				ts.Comparison.LessThan,
			);
			assert.strictEqual(
				new ts.Version("1.0.0-alpha.0").compareTo(
					new ts.Version("1.0.0-alpha"),
				),
				ts.Comparison.GreaterThan,
			);
			...
			assert.strictEqual(
				new ts.Version("1.0.0-a.0.b.1").compareTo(
					new ts.Version("1.0.0-a.0.b.2"),
				),
				ts.Comparison.LessThan,
			);
			assert.strictEqual(
				new ts.Version("1.0.0-a.0.b.1").compareTo(
					new ts.Version("1.0.0-b.0.a.1"),
				),
				ts.Comparison.LessThan,
			);
			assert.strictEqual(
				new ts.Version("1.0.0-a.0.b.2").compareTo(
					new ts.Version("1.0.0-a.0.b.1"),
				),
				ts.Comparison.GreaterThan,
			);
			assert.strictEqual(
				new ts.Version("1.0.0-b.0.a.1").compareTo(
					new ts.Version("1.0.0-a.0.b.1"),
				),
				ts.Comparison.GreaterThan,
			);
			...
			assert.strictEqual(
				new ts.Version("1.0.0+build").compareTo(
					new ts.Version("1.0.0"),
				),
				ts.Comparison.EqualTo,
			);
		});
		it("increment", () => {
			assertVersion(
				new ts.Version(1, 2, 3, "pre.4", "build.5").increment("major"),
				[2, 0, 0],
			);
			assertVersion(
				new ts.Version(1, 2, 3, "pre.4", "build.5").increment("minor"),
				[1, 3, 0],
			);
			assertVersion(
				new ts.Version(1, 2, 3, "pre.4", "build.5").increment("patch"),
				[1, 2, 4],
			);
		});
	});
	describe("VersionRange", () => {
		...
		it("patch wildcard types treated the same", () => {
			const versionStrings = ["1.2.*", "1.2.x", "1.2.X"];
			for (let i = 0; i < versionStrings.length; i++) {
				for (let j = i + 1; j < versionStrings.length; j++) {
					const left = new ts.VersionRange(versionStrings[i]);
					const right = new ts.VersionRange(versionStrings[j]);
