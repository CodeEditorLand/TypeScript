...
describe("unittests:: core paths", () => {
	...
	it("getDirectoryPath", () => {
		...
		assert.strictEqual(ts.getDirectoryPath("\\\\server\\"), "//server/");
		assert.strictEqual(
			ts.getDirectoryPath("\\\\server\\share"),
			"//server/",
		);
		assert.strictEqual(
			ts.getDirectoryPath("\\\\server\\share\\"),
		...
		assert.strictEqual(ts.getDirectoryPath("file:///c:/"), "file:///c:/");
		assert.strictEqual(
			ts.getDirectoryPath("file:///c:/path"),
			"file:///c:/",
		);
		assert.strictEqual(
			ts.getDirectoryPath("file:///c:/path/"),
		...
		assert.strictEqual(
			ts.getDirectoryPath("file://server"),
			"file://server",
		);
		assert.strictEqual(
			ts.getDirectoryPath("file://server/"),
		...
		assert.strictEqual(
			ts.getDirectoryPath("http://server"),
			"http://server",
		);
		assert.strictEqual(
			ts.getDirectoryPath("http://server/"),
	...
	it("getPathComponents", () => {
		...
		assert.deepEqual(ts.getPathComponents("file:///c:d"), [
			"file:///",
			"c:d",
		]);
		assert.deepEqual(ts.getPathComponents("file:///c:/"), ["file:///c:/"]);
