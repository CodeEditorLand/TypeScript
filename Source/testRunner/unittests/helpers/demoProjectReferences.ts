...
export function getFsContentsForDemoProjectReferencesCoreConfig(
	additional?: object,
) {
...
export function getFsForDemoProjectReferences() {
	return loadProjectFromFiles(getFsContentsForDemoProjectReferences(), {
...
export function getSysForDemoProjectReferences() {
	return createWatchedSystem(getFsContentsForDemoProjectReferences(), {
