...
describe("unittests:: tsc:: declarationEmit::", () => {
	...
	describe("with symlinks in sibling folders and common package referenced from both folders", () => {
		...
		verifyDeclarationEmit({
			...
			files: [
				{
					path: `/user/username/projects/myproject/plugin-two/index.d.ts`,
				...
				{
					path: `/user/username/projects/myproject/plugin-one/tsconfig.json`,
				...
				{
					path: `/user/username/projects/myproject/plugin-one/action.ts`,
