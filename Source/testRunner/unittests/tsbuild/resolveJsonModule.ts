...
describe("unittests:: tsbuild:: with resolveJsonModule option on project resolveJsonModuleAndComposite", () => {
	...
	verfiyJson(
		{
			subScenario:
				"include only with json without rootDir but outside configDirectory",
			modifyFs: (fs) => {
