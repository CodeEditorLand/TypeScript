...
export class Test {
	...
	public spans(): ts.TextSpan[] {
		return this.ranges().map((r) =>
			ts.createTextSpan(r.pos, r.end - r.pos),
		);
	}
...
export class Verify extends VerifyNegatable {
	...
	public baselineFindAllReferences(
		...markerOrRange: FourSlash.MarkerOrNameOrRange[]
	) {
		this.state.baselineFindAllReferences(
			markerOrRange,
			/*rangeText*/ undefined,
		);
	}
	...
	public baselineGoToDefinition(
		...
		this.state.baselineGoToDefinition(
			markerOrRange,
			/*rangeText*/ undefined,
		);
	}
	...
	public baselineGetDefinitionAtPosition(
		...
		this.state.baselineGetDefinitionAtPosition(
			markerOrRange,
			/*rangeText*/ undefined,
		);
	}
	...
	public baselineGoToSourceDefinition(
		...
		this.state.baselineGoToSourceDefinition(
			markerOrRange,
			/*rangeText*/ undefined,
		);
	}
	...
	public baselineGoToImplementation(
		...
		this.state.baselineGoToImplementation(
			markerOrRange,
			/*rangeText*/ undefined,
		);
	}
	...
	public baselineDocumentHighlights(
		...
		this.state.baselineDocumentHighlights(
			markerOrRange,
			/*rangeText*/ undefined,
			options,
		);
	...
	public docCommentTemplateAt(
		...
		this.state.verifyDocCommentTemplate(
			{
				newText: expectedText.replace(
					/\r?\n/g,
					ts.testFormatSettings.newLineCharacter!,
				),
	...
	public baselineRenameAtRangesWithText(
		rangeText?: ArrayOrSingle<string>,
		options?: RenameOptions,
	) {
		this.state.baselineRename(
...
export namespace Completion {
	...
	const deprecatedInterfaceEntry = (
		name: string,
	): ExpectedCompletionEntryObject => ({
		name,
		kind: "interface",
	...
	function combineExpectedCompletionEntries(
		...
		return Object.assign(
			sorted([...providedByHarness, ...providedByTest]),
			{ plusFunctionName: functionName, plusArgument: providedByTest },
		);
	}
	...
	function compareExpectedCompletionEntries(
		...
		const bSortText =
			...
			ts.Completions.SortText.LocationPriority;
		const bySortText = ts.compareStringsCaseSensitiveUI(
			aSortText,
			bSortText,
		);
